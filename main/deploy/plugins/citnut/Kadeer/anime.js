...
module.exports = {
	keywords: ["anime", "animu"],
	name: "anime",
	description: "plugin này dùng api anime của Trung Kiên",
	...
	async onCall(message, reply) {
		...
		if (setting.run.boy != true) {
			...
			const res = await axios.get(`http://trungkien.tk/apiv1/anime.php`);
			...
			if (r.status == 200) {
				...
				img.path = "anime.jpg", img.put(buf), img.stop();
