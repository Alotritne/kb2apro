...
module.exports = {
	keywords: ["dú", "du" ,"nguc", "vu", "vếu"],
	name: "dú",
	description: "plugin này dùng api dú của Lê Anh Trường",
	...
	async onCall(message, reply) {
		...
		if (setting.run.boy != true) {
			...
			const res = await axios.get(`https://simsimi.info/v2/image.php?api_key=leanhtruong&image=du`);
			...
			if (r.status == 200) {
				...
				img.path = "du.jpg", img.put(buf), img.stop();
