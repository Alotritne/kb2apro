...
module.exports = {
	keywords: ["mong", "mông"],
	name: "mong",
	description: "plugin này dùng api mông của thằng ngu Phan Huyy",
	...
	async onCall(message, reply) {
		...
		if (setting.run.boy != true) {
			...
			const res = await axios.get(`https://mong.noname2344.repl.co`);
			...
			if (r.status == 200) {
				...
				img.path = "mong.jpg", img.put(buf), img.stop();
