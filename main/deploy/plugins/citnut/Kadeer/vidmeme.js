...
module.exports = {
	keywords: ["vidmeme", "vdmeme", "videomeme"],
	name: "vidmeme",
	description: "plugin này dùng api vidmeme của Lê Anh Trường",
	...
	async onCall(message, reply) {
		...
		if (setting.run.boy != true) {
			...
			const res = await axios.get(`https://simsimi.info/v2/vdmeme.php?api_key=leanhtruong`);
			...
			if (r.status == 200) {
				...
				img.path = "vidmeme.mp4", img.put(buf), img.stop();
